    ...
    <div class="form">
      <a-tabs>
        <a-tab-pane key="1" tab="登录">
          ...
          <div class="item"><a-input placeholder="密码">
           <template v-slot:prefix>
             <LockOutlined />
            </template>
          </a-input>
          </div>
          <div class="item"><a href="">忘记密码</a></div>
          <div class="item"><a-button type="primary">登录</a-button></div>
        </a-tab-pane>
        ...
        <a-tab-pane key="2" tab="注册">
          ...
          <div class="item"><a-input placeholder="邀请码" >
           <template v-slot:prefix>
             <MailOutlined />
            </template>
          </a-input></div>

          <div class="item"><a-button type="primary">注册</a-button></div>
        </a-tab-pane>
      </a-tabs>
    </div>
  </div>
